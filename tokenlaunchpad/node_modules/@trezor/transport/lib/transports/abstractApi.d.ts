...
export declare abstract class AbstractApiTransport extends AbstractTransport {
    ...
    acquire({ input }: AbstractTransportMethodParams<'acquire'>): {
        promise: Promise<import("../types").ResultWithTypedError<`${number}`, "Unable to open device" | "device not found" | "wrong previous session" | "device disconnected during action" | "unexpected error" | "Aborted by signal" | "Aborted by timeout"> | {
            success: false;
            error: NonNullable<"Aborted by signal" | "Aborted by timeout">;
            message: string | undefined;
        } | {
    ...
    call({ session, name, data, protocol: customProtocol, }: AbstractTransportMethodParams<'call'>): {
        promise: Promise<{
            success: false;
            error: NonNullable<"Aborted by signal" | "Aborted by timeout">;
            message: string | undefined;
    ...
    send({ data, session, name, protocol }: AbstractTransportMethodParams<'send'>): {
        promise: Promise<import("../types").Success<undefined> | {
            ...
            success: false;
            error: NonNullable<"device disconnected during action" | "Aborted by signal">;
            message: string | undefined;
        } | {
            success: false;
            error: "unexpected error";
    ...
    receive({ session, protocol: customProtocol, }: AbstractTransportMethodParams<'receive'>): {
        promise: Promise<{
            success: false;
            error: NonNullable<"Aborted by signal" | "Aborted by timeout">;
            message: string | undefined;
