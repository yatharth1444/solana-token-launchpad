...
class UsbApi extends abstract_1.AbstractApi {
    constructor({ usbInterface, logger, forceReadSerialOnConnect }) {
        super({ logger });
        this.chunkSize = 64;
        this.devices = [];
    ...
    enumerate(signal) {
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const devices = yield this.abortableMethod(() => this.usbInterface.getDevices(), signal);
    ...
    read(path, signal) {
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const res = yield this.abortableMethod(() => device.transferIn(constants_1.ENDPOINT_ID, this.chunkSize), signal);
    ...
    write(path, buffer, signal) {
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const result = yield this.abortableMethod(() => device.transferOut(constants_1.ENDPOINT_ID, newArray), signal);
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            if (first) {
                try {
                    ...
                    yield this.abortableMethod(() => device.selectConfiguration(constants_1.CONFIGURATION_ID), signal);
                ...
                try {
                    ...
                    yield this.abortableMethod(() => device.reset(), signal);
            ...
            try {
                ...
                yield this.abortableMethod(() => device.claimInterface(constants_1.INTERFACE_ID), signal);
                (_l = this.logger) === null || _l === void 0 ? void 0 : _l.debug(`usb: device.claimInterface done: ${constants_1.INTERFACE_ID}. device: ${this.formatDeviceForLog(device)}`);
            }
            catch (err) {
