...
import { EnumerateDoneRequest, AcquireIntentRequest, ReleaseIntentRequest, ReleaseDoneRequest, GetPathBySessionRequest, AcquireDoneRequest, RegisterBackgroundCallbacks } from './types';
...
export declare class SessionsClient extends TypedEmitter<{
    ...
    enumerateIntent(): Promise<import("../types").Success<void> & {
        id: number;
    }>;
