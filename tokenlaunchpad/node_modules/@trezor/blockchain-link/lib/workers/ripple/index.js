...
const getTransaction = ({ connect, payload }) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
...
const pushTransaction = ({ connect, payload }) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    const api = yield connect();
...
const unsubscribeAddresses = ({ state, connect }, addresses) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    const api = yield connect();
    if (!addresses) {
...
const unsubscribeBlock = ({ state, connect }) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
